            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-16">
                    ...
                    <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-[#0F0F0F]">
                        {searchQuery ? "Found Treasures" : "Our Entire Catalogue"}
                    </h1>
                </div>

                {filteredProducts.length === 0 ? (
                    <div className="text-center py-20">
                        <p className="text-xl text-gray-500 font-serif">No treasures found matching your search.</p>
                        <Link to="/collection" className="text-[#8B2F2F] underline mt-4 inline-block">View all products</Link>
                    </div>
                ) : (
                        ...
                        {filteredProducts.map((product, index) => (
                            ...
                            >
                                <div className="flex flex-col md:flex-row">
                                    {/* Image */}
                                    <div className="md:w-1/3 lg:w-1/4 h-64 md:h-auto relative overflow-hidden bg-gradient-to-br from-[#8B2F2F]/20 to-[#8B2F2F]/5">
                                        <img
                                            src={product.image}
                                            alt={product.name}
                ...
                <div className="text-center mt-20">
                    <p className="font-serif text-xl md:text-2xl text-[#8B2F2F] italic opacity-80">
                        More Arrivals Soon...
                    </p>
                </div>
            </div>
